 ...
 */
int
dot1dStpPortTable_indexes_set_tbl_idx(dot1dStpPortTable_mib_index *tbl_idx, long dot1dStpPort_val)
{
 ...
 */
int
dot1dStpPortTable_indexes_set(dot1dStpPortTable_rowreq_ctx *rowreq_ctx, long dot1dStpPort_val)
{
    DEBUGMSGTL(("verbose:dot1dStpPortTable:dot1dStpPortTable_indexes_set","called\n"));

    if(MFD_SUCCESS != dot1dStpPortTable_indexes_set_tbl_idx(&rowreq_ctx->tbl_idx
                                   , dot1dStpPort_val
           ))
        return MFD_ERROR;
    ...
    if(0 != dot1dStpPortTable_index_to_oid(&rowreq_ctx->oid_idx,
                                    &rowreq_ctx->tbl_idx)) {
        return MFD_ERROR;
    }
 ...
 */
int
dot1dStpPortPriority_get( dot1dStpPortTable_rowreq_ctx *rowreq_ctx, long * dot1dStpPortPriority_val_ptr )
{
 ...
 */
int
dot1dStpPortState_get( dot1dStpPortTable_rowreq_ctx *rowreq_ctx, u_long * dot1dStpPortState_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
dot1dStpPortEnable_get( dot1dStpPortTable_rowreq_ctx *rowreq_ctx, u_long * dot1dStpPortEnable_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
dot1dStpPortPathCost_get( dot1dStpPortTable_rowreq_ctx *rowreq_ctx, long * dot1dStpPortPathCost_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
dot1dStpPortDesignatedRoot_get( dot1dStpPortTable_rowreq_ctx *rowreq_ctx, char **dot1dStpPortDesignatedRoot_val_ptr_ptr, size_t *dot1dStpPortDesignatedRoot_val_ptr_len_ptr )
{
 ...
 */
    ...
    if ((NULL == (* dot1dStpPortDesignatedRoot_val_ptr_ptr )) ||
         ...
         */
        (* dot1dStpPortDesignatedRoot_val_ptr_ptr ) = malloc(rowreq_ctx->data.dot1dStpPortDesignatedRoot_len* sizeof(rowreq_ctx->data.dot1dStpPortDesignatedRoot[0]));
        if(NULL == (* dot1dStpPortDesignatedRoot_val_ptr_ptr )) {
            snmp_log(LOG_ERR,"could not allocate memory (rowreq_ctx->data.dot1dStpPortDesignatedRoot)\n");
            return MFD_ERROR;
        }
    }
    (* dot1dStpPortDesignatedRoot_val_ptr_len_ptr ) = rowreq_ctx->data.dot1dStpPortDesignatedRoot_len* sizeof(rowreq_ctx->data.dot1dStpPortDesignatedRoot[0]);
    memcpy( (* dot1dStpPortDesignatedRoot_val_ptr_ptr ), rowreq_ctx->data.dot1dStpPortDesignatedRoot, rowreq_ctx->data.dot1dStpPortDesignatedRoot_len* sizeof(rowreq_ctx->data.dot1dStpPortDesignatedRoot[0]) );
 ...
 */
int
dot1dStpPortDesignatedCost_get( dot1dStpPortTable_rowreq_ctx *rowreq_ctx, long * dot1dStpPortDesignatedCost_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
dot1dStpPortDesignatedBridge_get( dot1dStpPortTable_rowreq_ctx *rowreq_ctx, char **dot1dStpPortDesignatedBridge_val_ptr_ptr, size_t *dot1dStpPortDesignatedBridge_val_ptr_len_ptr )
{
   /** we should have a non-NULL pointer and enough storage */
 ...
 */
    ...
    if ((NULL == (* dot1dStpPortDesignatedBridge_val_ptr_ptr )) ||
         ...
         */
        (* dot1dStpPortDesignatedBridge_val_ptr_ptr ) = malloc(rowreq_ctx->data.dot1dStpPortDesignatedBridge_len* sizeof(rowreq_ctx->data.dot1dStpPortDesignatedBridge[0]));
        if(NULL == (* dot1dStpPortDesignatedBridge_val_ptr_ptr )) {
            snmp_log(LOG_ERR,"could not allocate memory (rowreq_ctx->data.dot1dStpPortDesignatedBridge)\n");
            return MFD_ERROR;
        }
    }
    ...
    memcpy( (* dot1dStpPortDesignatedBridge_val_ptr_ptr ), rowreq_ctx->data.dot1dStpPortDesignatedBridge, rowreq_ctx->data.dot1dStpPortDesignatedBridge_len* sizeof(rowreq_ctx->data.dot1dStpPortDesignatedBridge[0]) );
 ...
 */
int
dot1dStpPortDesignatedPort_get( dot1dStpPortTable_rowreq_ctx *rowreq_ctx, char **dot1dStpPortDesignatedPort_val_ptr_ptr, size_t *dot1dStpPortDesignatedPort_val_ptr_len_ptr )
{
   /** we should have a non-NULL pointer and enough storage */
 ...
 */
    ...
    if ((NULL == (* dot1dStpPortDesignatedPort_val_ptr_ptr )) ||
         ...
         */
        (* dot1dStpPortDesignatedPort_val_ptr_ptr ) = malloc(rowreq_ctx->data.dot1dStpPortDesignatedPort_len* sizeof(rowreq_ctx->data.dot1dStpPortDesignatedPort[0]));
        if(NULL == (* dot1dStpPortDesignatedPort_val_ptr_ptr )) {
            snmp_log(LOG_ERR,"could not allocate memory (rowreq_ctx->data.dot1dStpPortDesignatedPort)\n");
            return MFD_ERROR;
        }
    }
    ...
    memcpy( (* dot1dStpPortDesignatedPort_val_ptr_ptr ), rowreq_ctx->data.dot1dStpPortDesignatedPort, rowreq_ctx->data.dot1dStpPortDesignatedPort_len* sizeof(rowreq_ctx->data.dot1dStpPortDesignatedPort[0]) );
 ...
 */
int
dot1dStpPortForwardTransitions_get( dot1dStpPortTable_rowreq_ctx *rowreq_ctx, u_long * dot1dStpPortForwardTransitions_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
dot1dStpPortPathCost32_get( dot1dStpPortTable_rowreq_ctx *rowreq_ctx, long * dot1dStpPortPathCost32_val_ptr )
{
   /** we should have a non-NULL pointer */
