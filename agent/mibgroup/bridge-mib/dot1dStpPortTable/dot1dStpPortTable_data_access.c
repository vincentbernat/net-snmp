 ...
 */
int
dot1dStpPortTable_init_data(dot1dStpPortTable_registration * dot1dStpPortTable_reg)
{
 ...
 */
void
dot1dStpPortTable_container_init(netsnmp_container **container_ptr_ptr,
                             netsnmp_cache *cache)
{
 ...
 */
void
dot1dStpPortTable_container_shutdown(netsnmp_container *container_ptr)
{
