...
#define COLUMN_DOT1DBASEPORT_FLAG    (0x1 << 0)
    
#define COLUMN_DOT1DBASEPORTIFINDEX         2
#define COLUMN_DOT1DBASEPORTIFINDEX_FLAG    (0x1 << 1)
    
#define COLUMN_DOT1DBASEPORTCIRCUIT         3
#define COLUMN_DOT1DBASEPORTCIRCUIT_FLAG    (0x1 << 2)
    
#define COLUMN_DOT1DBASEPORTDELAYEXCEEDEDDISCARDS         4
#define COLUMN_DOT1DBASEPORTDELAYEXCEEDEDDISCARDS_FLAG    (0x1 << 3)
    
#define COLUMN_DOT1DBASEPORTMTUEXCEEDEDDISCARDS         5
#define COLUMN_DOT1DBASEPORTMTUEXCEEDEDDISCARDS_FLAG    (0x1 << 4)
