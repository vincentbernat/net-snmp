...
config_require(bridge-mib/data_access/fdb)
...
*/
#define MAX_dot1dTpFdbTable_IDX_LEN     7
...
extern const oid dot1dTpFdbTable_oid[];
extern const int dot1dTpFdbTable_oid_size;
