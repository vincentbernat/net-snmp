 ...
 */
int
dot1dTpFdbTable_indexes_set_tbl_idx(dot1dTpFdbTable_mib_index *tbl_idx, char *dot1dTpFdbAddress_val_ptr,  size_t dot1dTpFdbAddress_val_ptr_len)
{
    ...
    if ((NULL == tbl_idx->dot1dTpFdbAddress) ||
        ...
        snmp_log(LOG_ERR,"not enough space for value (dot1dTpFdbAddress_val_ptr)\n");
        return MFD_ERROR;
    }
    tbl_idx->dot1dTpFdbAddress_len = dot1dTpFdbAddress_val_ptr_len;
    memcpy( tbl_idx->dot1dTpFdbAddress, dot1dTpFdbAddress_val_ptr, dot1dTpFdbAddress_val_ptr_len* sizeof(dot1dTpFdbAddress_val_ptr[0]) );
 ...
 */
int
dot1dTpFdbTable_indexes_set(dot1dTpFdbTable_rowreq_ctx *rowreq_ctx, char *dot1dTpFdbAddress_val_ptr,  size_t dot1dTpFdbAddress_val_ptr_len)
{
    DEBUGMSGTL(("verbose:dot1dTpFdbTable:dot1dTpFdbTable_indexes_set","called\n"));

    if(MFD_SUCCESS != dot1dTpFdbTable_indexes_set_tbl_idx(&rowreq_ctx->tbl_idx
 ...
 */
int
dot1dTpFdbPort_get( dot1dTpFdbTable_rowreq_ctx *rowreq_ctx, long * dot1dTpFdbPort_val_ptr )
{
 ...
 */
int
dot1dTpFdbStatus_get( dot1dTpFdbTable_rowreq_ctx *rowreq_ctx, u_long * dot1dTpFdbStatus_val_ptr )
{
   /** we should have a non-NULL pointer */
